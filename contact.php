...
<head>
    ...
    <meta name="keywords" content="Mediconnect is HealthCare Social Networking website" />
...
<!-- header -->
    ...
    <div class="w3layouts-breadcrumbs text-center">
        <div class="container">
            <span class="agile-breadcrumbs"><a href="index.php">Home</a> > <a href="contact.php"> Contact Us </a> > <span>Faq</span></span>
        </div>
    </div>
    <!-- //breadcrumbs -->
    <!-- //banner -->
        ...
        <div class="col-md-3 w3_agileits-contact-inner">
                <ul class="w3-inner-contact">
                    <li class="active"><a href="contact.php">faq</a></li>
                     <li><a href="media.php">mediacontact</a></li>
                </ul>
            </div>
        <div class="col-md-8 agileinfo-contact-main-address">
            <h4 class="w3ls-inner-title">Mediconnect faq's</h4>
            <div class="panel-group faq-w3ls" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <h5 class="panel-title asd">
                            <a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false"
                                aria-controls="collapseOne">
										<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span><i class="glyphicon glyphicon-chevron-down" aria-hidden="true"></i>What happens if I don’t get a response ?
									</a>
                        </h5>
                    </div>
                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false"
                        style="height: 0px;">
                        <div class="panel-body panel_text faq-w3">
                           You’re assured a response on Mediconnect Consult. If you’re asking a free question, we assign your question to our doctors and you’re likely to receive not one but multiple opinions. If you’re paying to chat with a doctor privately, we’ll ensure you get a response in 1-3 hours (between 10AM - 8PM) and if you don’t get a response in time, we’ll refund your money. No questions asked!
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                        ...
                        <h5 class="panel-title asd">
                            <a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false"
                                aria-controls="collapseTwo">
										<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span><i class="glyphicon glyphicon-chevron-down" aria-hidden="true"></i>Will the doctor be able to solve my medical issue ?
									</a>
                        </h5>
                    </div>
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo" aria-expanded="false"
                        style="height: 0px;">
                        <div class="panel-body panel_text faq-w3">
                        Our doctors will give you a qualified opinion on your health issue and help you identify next steps which may include further tests, a prescription or lifestyle tips. On the off chance that our doctors can’t form a conclusive diagnosis without a physical examination, they will cancel the consultation & refund your money. </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingThree">
                        <h5 class="panel-title asd">
                            ...
                            aria-controls="collapseThree">
                                    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span><i class="w3ls-icon glyphicon glyphicon-chevron-down" aria-hidden="true"></i>Are your doctors qualified ?
                                </a>
                        </h5>
                    </div>
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree" aria-expanded="false"
                        style="height: 0px;">
                        <div class="panel-body panel_text faq-w3">
                          We have a strict verification process for every doctor on Practo. Any doctor that you consult with is a verified medical practitioner .
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                        ...
                        <h5 class="panel-title asd">
                            <a class="pa_italic" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="true"
                                aria-controls="collapseFour">
										<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span><i class="glyphicon glyphicon-chevron-down" aria-hidden="true"></i>
										When should I not use Mediconnect.com ?
									</a>
                        </h5>
                    </div>
                    <div id="collapseFour" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFour" aria-expanded="false">
                        <div class="panel-body panel_text faq-w3">
                        Mediconnect and for that matter, any online medical service shouldn't be used when it is an emergency when your symptoms are out of the ordinary and would require immediate attention. We would be of limited help when a physical checkup is essential or a prescription is needed. 
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingFive">
                        <h5 class="panel-title asd">
                            <a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false"
                                aria-controls="collapseOne">
										<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span><i class="glyphicon glyphicon-chevron-down" aria-hidden="true"></i>
											What is your privacy and safety policy ?
									</a>
                        </h5>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingSix">
                        <h5 class="panel-title asd">
                            <a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="false"
                                aria-controls="collapseOne">
										<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span><i class="glyphicon glyphicon-chevron-down" aria-hidden="true"></i>How can I reach you ?
									</a>
                        </h5>
                    </div>
                    <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false"
                        style="height: 0px;">
                        <div class="panel-body panel_text faq-w3">
                           Email us at mediconnect@gmail.com. We generally reply within an moment.
                        </div>
                    </div>
                </div>
            </div>
