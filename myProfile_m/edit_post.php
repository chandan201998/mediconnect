								...
								<!--sub-heard-part-->
								  ...
								  <!--//sub-heard-part-->
										<div class="graph-visual">
											<h2 class="inner-tittle">Update Your Post!</h2>
											           <div class="maark-edit graph">
													       						<form action="" method="post">
													  <div class="form-group">
														<input class="form-control" name="title" type="text" value="<?php include 'connection.php';
														if(isset($_GET['post_id']))
																		{
																			$post_id=$_GET['post_id'];
																			$run="SELECT * from posts where post_id='$post_id'";
																			$runquery=mysqli_query($conn,$run);
																			$fetch=mysqli_fetch_array($runquery);
																			$content=$fetch['post_title'];
																			echo $content;
																		}
														?>">
													  </div>
																	...
																	<textarea name="content" data-provide="markdown" rows="10" class="md-input" style="resize: none;" ><?php include 'connection.php';
																		if(isset($_GET['post_id']))
																		{
																			$post_id=$_GET['post_id'];
																			$run="SELECT * from posts where post_id='$post_id'";
																	...
																	?></textarea>
																				...
																				<div class="form-group"> <label for="exampleInputFile"> </label> <input type="file" id="exampleInputFile"> </div> 
																						  ...
																						  <hr>
																						  <button name="update" type="submit" class="btn"> Update Your Post</button>
																</form>
														...
														if(isset($_POST['update'])){
															...
															$updatepost="UPDATE posts SET post_title='$title',post_content='$content' WHERE post_id='$post_id'";
															$runupdate=mysqli_query($conn,$updatepost);
															if($runupdate){
