										...
										<!--/calender-->
											<div class="cal-main">
													<div class="calender graph-form">
														<h2 class="inner-tittle"> Schedule Calender</h2>
														<div class="cal1">
														...
														<!--/Tooltips-->
															...
															<!--/Accordion-->
														 <div class="accordion">
															<h3 class="inner-tittle two">Mediconnect Faqs</h3>
															<div class="panel-group tool-tips graph-form" id="accordion" role="tablist" aria-multiselectable="true">
																...
																Will The Doctor Be Able To Solve My Medical Issue ?
																		</a>
																	  </h4>
																	</div>
																  ...
																  <div class="panel-default">
																	...
																	<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree" aria-expanded="false" style="height: 0px;">
																	  <div class="panel-body">
																	We have a strict verification process for every doctor on Mediconnect. Any doctor that you consult with is a verified medical practitioner . </div>
																	</div>
																  </div>
															  <div class="panel-default">
																...
																<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour" aria-expanded="false" style="height: 0px;">
																  <div class="panel-body">
																Mediconnect and for that matter, any online medical service shouldn't be used when it is an emergency when your symptoms are out of the ordinary and would require immediate attention. We would be of limited help when a physical checkup is essential or a prescription is needed.</div>
																</div>
															  </div>
															  <div class="panel-default">
																...
																<div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive" aria-expanded="false" style="height: 0px;">
																  <div class="panel-body">
																We follow industry standard security practices, and absolutely none of your personal information (email, personally identifiable information, reports, scans) is shared with anyone except the consulting Doctors. Please don't add names, emails, contact numbers to your questions. </div>
																</div>
														  </div>
														</div>
													</div>
