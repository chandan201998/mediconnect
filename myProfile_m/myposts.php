		...
		<!-- header-starts -->
			<div class="header-section">
   			...
   			<div id="content-timeline" class="container">
												 		...
												 		$id=$row['id'];
														 ?>
														<h2 style="text-decoration: underline;color: red">My Posts !</h2>
															<hr>
																...
																$get_posts="SELECT * from posts WHERE id='$id' ORDER BY 1 DESC";
																...
																while($row_posts=mysqli_fetch_array($run_posts)){
																	...
																	echo "
																	 ...
																	 <p><img src='images/$u_image' width='6%' height='4%' alt='No image'></p>
