	   ...
	   <div class="inner-content">
		<!-- header-starts -->
			<div class="header-section">
														 ...
														 ?>
															...
															//getting the user session
																	...
																	$user_com=$_SESSION['email'];
												  					$get_com="SELECT * from authenticate_user where email='$user_com'";
																	$query_com=mysqli_query($conn,$get_com);
												 					$row_com=mysqli_fetch_array($query_com);
												 					$id_com=$row_com['id'];
												 					$user_com=$row_com['name'];
															...
															if(isset($_GET['post_id'])){
																...
																$row_posts=mysqli_fetch_array($run_posts);
																	...
																	echo "
																	 ...
																	 <div id='posts'>
																	 <p><img src='images/$u_image' width='6%' height='4%'></p>
																	 <h3><a href='profile.php?id=$id'>$name</a></h3>
																	 <h2>$post_title</h2>
																	 <p>$post_date</p>
																	 <p><h3>$post_content</h3></p>
																	 </div>
																	 <br>";
																	 ...
																	 echo "<form action='' method='post' id='addcomment'>
																	 <textarea id='replytext' cols='100%' rows='10%' placeholder='Write Your Reply' name='comment'>
																	 </textarea><br>
																	 <input id='replybutton' type='submit' name='reply' value='Reply To This'>
																	 </form>
																	 ";
				...
				$insert="INSERT into comments (post_id,id,comment,comment_author,date) values ('$post_id','$id','$comment','$user_com',NOW())";
