...
<body>
   <!-- header -->
    ...
    <div class="w3layouts-breadcrumbs text-center">
        <div class="container">
            <span class="agile-breadcrumbs"><a href="index.php">Home</a> > <a href="about.php">About us</a> <span>My App</span></span>
        </div>
    </div>
    <!-- //breadcrumbs -->
    <div class="container">
...
<div class="jarallax w3ls-section w3ls-features" id="features">
	<div class="container">
		 <h4 class="w3ls-inner-title">Details</h4>
		<h5 class="h-t">Manage all your accounts anytime. anywhere.</h5>
		<ul class="app-w3ls">
		</ul>
		<div class="clearfix"></div>
		<div class=" col-md-7 col-sm-8 col-xs-8 feature-main fm-right">	
			<img src="images/patient.png" class="img-responsive" alt="" />
		</div>
		<div class=" col-md-5 col-sm-4 col-xs-4 feature-main">
											...
											<form action="signup.php" method="post">
												...
												<div class="signin-rit">
													<span class="agree-checkbox">
														<label class="checkbox"><input type="checkbox" name="checkbox">I agree to your <a class="w3layouts-t" href="#" href="terms.php">Terms of Use</a> and <a class="w3layouts-t" href="privacy.php" target="_blank">Privacy Policy</a></label>
													</span>
												</div>
												<div class="tp">
