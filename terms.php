...
<head>
    <title>Mediconnect is a HealthCare social networking website .</title>
    <!-- for-mobile-apps -->
...
<body>
   <!-- header -->
    ...
    <div class="w3layouts-breadcrumbs text-center">
        <div class="container">
            <span class="agile-breadcrumbs"><a href="index.php">Home</a> > <span></span>Terms and Conditions</span>
        </div>
    </div>
    <!-- //breadcrumbs -->
	<div class="general_social_icons">
	...
	<div class="container">
	<div class="agile-terms w3ls-section">
		<section class="terms-of-use">			
			<!-- terms -->
			<div class="terms">
                    <h4 class="w3ls-inner-title">Terms and Conditions</h4>
					<h6>Important Points</h6>
					<ol start="1">
						<li>Mediconnect has taken great care in the development and presentation of this website and the material present on it. However, there may be inadvertent and occasional errors for which we apologise, but for which we can accept no liability.
</li><li>By using the site, you agree to be bound by these Terms. We reserve the right, in our sole discretion, to change, modify, add or remove portions of these Terms at any time.</li>
					</ol>
					<h6>Exclusions and Limitations</h6>
					<p>The Site has been created and is controlled by Mediconnect Ltd in India. These Terms will be governed by, and construed and enforced in accordance with, the laws of India. You hereby unconditionally and irrevocably submit to the exclusive jurisdiction of the Irish courts.</p>
						<h6>Disclaimer</h6>
					<ol start="1">
						<li>Mediconnect Ltd has taken care in the preparation of the content of this website. To the fullest extent permitted by the law, Mediconnect Ltd disclaims all warranties of any kind with respect to the content of this website.</li>
					</ol>
                    <h6>Payment</h6>
						<p>You are responsible for providing valid credit or debit card details and in doing so you are authorising us to take payment in full for the service and warrant that you are authorised to use the card. Our pricing is clearly displayed on the website. Prices include post and packaging.</p>
						<h6>Declaration</h6>
						<p>By agreeing to our Terms and Conditions and using the site, you declare you wish to take part in the online medical consultation service operated by Mediconnect Ltd through the Mediconnect.ie website. The online consultations are subject to the terms and conditions set out in this agreement.</p>
			</div>
			<!-- /terms -->
		</section>
	</div>
