...
<body>
  <!-- header -->
    ...
    <div class="w3layouts-breadcrumbs text-center">
        <div class="container">
            <span class="agile-breadcrumbs"><a href="index.php">Home</a> > <a href="about.php">About</a> > <span>Reviews</span></span>
        </div>
    </div>
    <!-- //breadcrumbs -->
	...
	<!--client-->
	<div class="container">
	<div class="w3ls-section client">
		
		<h4 class="w3ls-inner-title">what our Client Says</h4>
			<!--screen-gallery-->
							      ...
							      <div class="item-owl">
					                	<div class="customer-say">
											  <div class="col-md-6 customer-grid">
												<div class="de_testi">
													<div class="quotes"><img src="images/kn.jpg" alt=""></div>
														<div class="de_testi_by">
															<p> “I got answers to all my medical queries. I’ll definitely recommend online consultations on Mediconnect to others.“
</p>
															<a href="#">Karthik Nair </a>,User
														</div>
															<div class="clearfix"></div>     
												</div>
											   </div>
											<div class="col-md-6 customer-grid">
											   <div class="de_testi">
													<div class="quotes"><img src="images/pp.jpg" alt=""></div>
														<div class="de_testi_by">
															<p> “The consultation on Mediconnect was great and I’m very happy with the experience. Would certainly ask other people to consult online.“</p>
															<a href="#"> Purvam Pujari </a>, User
														</div>
														<div class="clearfix"></div>
												</div>
											</div>
					                 ...
					                 <div class="item-owl">
					                	<div class="customer-say">
											  <div class="col-md-6 customer-grid">
												<div class="de_testi">
													<div class="quotes"><img src="images/hp.jpg" alt=""></div>
														<div class="de_testi_by">
															<p> “Excellent experience consulting on Mediconnect. I could solve my health issue without going to a clinic! Highly recommended!“</p>
															<a href="#">Harsh Parekh </a>, User
														</div>
															<div class="clearfix"></div>     
												</div>
											   </div>
											<div class="col-md-6 customer-grid">
											   <div class="de_testi">
													<div class="quotes"><img src="images/12.jpg" alt=""></div>
														<div class="de_testi_by">
															<p> "I had always been scared about trusting health-related information that is available online. However with Mediconnect, I can be sure that the advice I get is from from genuine doctors."</p>
															<a href="#"> Chie Chan</a> ,User
														</div>
														<div class="clearfix"></div>
												</div>
											</div>
					                 ...
					                 <div class="item-owl">
					                	<div class="customer-say">
											  <div class="col-md-6 customer-grid">
												<div class="de_testi">
													<div class="quotes"><img src="images/11.jpg" alt=""></div>
														<div class="de_testi_by">
											...
											<div class="col-md-6 customer-grid">
											   <div class="de_testi">
													<div class="quotes"><img src="images/13.jpg" alt=""></div>
														<div class="de_testi_by">
															<p> 
"Love the personal service and attention I receive when I come here."</p>
															<a href="#">John Mosbi</a>, User
														</div>
														<div class="clearfix"></div>
												</div>
											</div>
