...
<div class="header">
    ...
    <div class="w3layouts-breadcrumbs text-center">
        <div class="container">
            <span class="agile-breadcrumbs"><a href="index.php">Home</a> > <span></span>Privacy policy</span>
        </div>
    </div>
    <!-- //breadcrumbs -->
	<div class="general_social_icons">
	...
	<!-- privacy policy -->
  	<div class="container">
		...
		<h4 class="w3ls-inner-title">privacy policy</h4>
		<p>Mediconnect is committed to respecting the privacy rights of our customers, visitors, and other users of our services (“Services”) provided via this website (collectively, “Site”). We created this Site Privacy Policy (“Privacy Policy”) to give you confidence as you visit and use the Site, and to demonstrate our commitment to fair information practices and the protection of privacy. This Privacy Policy is only applicable to the Site, and not to any other websites that you may be able to access from the Site or any website of our partners, each of which may have data collection, storage, and use practices and policies that differ materially from this Privacy Policy. Your use of the Site is governed by this Privacy Policy and the Terms of Use. If you are registering an account or using the Site on behalf of an individual or entity other than yourself, you represent that you are authorized by such individual or entity to accept this Privacy Policy on such individual’s or entity’s behalf.</p>
		<h4>Confidentiality and Security</h4>
		<p class="privacy-para">Except as otherwise provided in this Privacy Policy, we will keep your Personal Information private and will not share it with third parties, unless we believe in good faith that disclosure of your Personal Information or any other information we collect about you is necessary to:</p>
		<ul class="privacy-start">
			<li><a ><i></i> comply with a court order or other legal process .</a></li>
			<li><a ><i></i>protect the rights, property or safety of our web site or another party .</a></li>
			<li><a ><i></i>enforce our Terms of Use .</a></li>
			<li><a ><i></i>respond to claims that any posting or other content violates the rights of third-parties. .</a></li>
		</ul>
		<h4 class="use-privay">Links to Other Websites</h4>
		<ul class="privacy-start">
			<li><a ><i></i>The Site may contain links to third party websites to which we have no affiliation. We don’t share your personal information with those websites and is not responsible for their privacy practices. Some web sites may have the look and feel of our Site. Please be aware that you may be on a different site and that this Privacy Policy only covers our Site. Should you decide to visit one of these third party websites, we suggest that you read its privacy policy.</a></li>
		</ul>

<h4 class="use-privay">Refund Policy for Doctor consultation</h4>
		<ul class="privacy-start">
			<li><a ><i></i>If you are not 100% satisfied with online consultation with any of our specialist, you can exchange it for another specialist consultation and we will not be refunding the amount for the consultation taken..</a></li>
		</ul>
