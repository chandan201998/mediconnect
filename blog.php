...
<body>
   <!-- header -->
    ...
    <div class="w3layouts-breadcrumbs text-center">
        <div class="container">
            <span class="agile-breadcrumbs"><a href="index.php">Home</a> > <span>Blog</span></span>
        </div>
    </div>
    <!-- //breadcrumbs -->
	<div class="general_social_icons">
	...
	<h4 class="w3ls-inner-title">our blog</h4>
	<div class="col-md-7  blog-left">
			<div class="post-media">
				  <a ><img src="images/bl2.jpg" class="img-responsive" alt=""></a>
				  <div class="blog-text">
						<a ><h3 class="h-t">Tips To Manage Mental Health In The Workplace</h3></a>
					  <div class="entry-meta">
							<h6 class="blg"><i class="fa fa-clock-o"></i> Jan 25, 2017</h6>
							<div class="icons">
								<a href="#"><i class="fa fa-user"></i> Admin</a>
								<a href="#"><i class="fa fa-comments-o"></i> 12</a>
								<a href="#"><i class="fa fa-thumbs-o-up"></i> 22</a>
								<a href="#"><i class="fa fa-thumbs-o-down"></i> 6</a>
							</div>
								<div class="clearfix"></div>
							<p>A significant portion of our adult life is spent in the workplace. Therefore, our physical and mental well-being at our workplace is of utmost significance. A positive mental health is not only beneficial for the health of the employees but also benefits the company by boosting their productivity. Unfortunately, mental health disorders often go unnoticed. If left untreated, it can .</p>
					  </div>
				  </div>
			</div>
			<div class="post-media second">
				  <a ><img src="images/bl3.jpg" class="img-responsive" alt=""></a>
				  <div class="blog-text">
						<a ><h3 class="h-t">Common Myths About Heart Disease</h3></a>
					  <div class="entry-meta">
							<h6 class="blg"><i class="fa fa-clock-o"></i> Feb 13, 2017</h6>
							<div class="icons">
								<a href="#"><i class="fa fa-user"></i> Admin</a>
								<a href="#"><i class="fa fa-comments-o"></i> 33</a>
								<a href="#"><i class="fa fa-thumbs-o-up"></i> 152</a>
								<a href="#"><i class="fa fa-thumbs-o-down"></i> 46</a>
							</div>
								<div class="clearfix"></div>
							<p>The heart is a four-chambered organ which pumps deoxygenated blood to the lungs for oxygenation and then pumps the oxygen-rich blood back to the whole body. Any problems in the structure of the heart can affect its functioning. Most heart conditions affect the cardiac muscles, the blood vessels, the electrical conduction system, and the valves of the heart.</p>
					  </div>
				  </div>
			</div>
			<div class="post-media">
				  <a ><img src="images/bl1.jpg" class="img-responsive" alt=""></a>
				  <div class="blog-text">
						<a ><h3 class="h-t">FAQs About Cancer</h3></a>
					  <div class="entry-meta">
							<h6 class="blg"><i class="fa fa-clock-o"></i> Mach 30, 2017</h6>
							<div class="icons">
								<a href="#"><i class="fa fa-user"></i> Admin</a>
								...
								<div class="clearfix"></div>
							<p>Cancer is a condition in which the body’s cells begin to divide and spread into the surrounding tissues. An accumulation of cancer cells leads to the formation of a tumor which can possibly be malignant. The human body is made up of trillions of cells and cancer can start anywhere within this area. When cancer tumor develops, the cell cycle .</p>
					  </div>
				  </div>
			</div>
			<!--start-blog-pagenate-->
				<div class="blog-pagenat">
					<ul>
						<li><a class="frist" >Prev</a></li>
						<li><a class="last" >Next</a></li>
					</ul>
					<div class="clearfix"> </div>
				</div>
				<!--//end-blog-pagenate-->
		...
		<div class="col-md-5 blog-right">
			<h4 class="widget-title">Mediconnect</h4>
		...
		<h4 class="widget-title">Popular Blog Posts</h4>
			<ul>
				<li>
					<a href="http://drgrumpyinthehouse.blogspot.in">Doctor Grumpy</a>
					<span class="post-date">Feb 13, 2017</span>
				</li>
				<li>
					<a href="http://roguemedic.com">Rogue Medic</a>
					<span class="post-date">Mar 21, 2017</span>
				</li>
				<li>
					<a href="http://www.bodyinmind.org">Body in Mind</a>
					<span class="post-date">Jun 16, 2017</span>
				</li>
				<li>
					<a href="http://healthaffairs.org/blog/">Health Affairs Blog</a>
					<span class="post-date">Aug 1, 2017</span>
				</li>
				<li>
					<a href="index.php">Reporting on Health Blogs</a>
