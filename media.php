            ...
            <div class="col-md-3 w3_agileits-contact-inner">
                <ul class="w3-inner-contact">
                    <li><a href="contact.php">faq</a></li>
                     <li class="active"><a href="media.php">mediacontact</a></li>
                </ul>
            </div>
            <div class="col-md-9 agileinfo-contact-main-address">
                <h4 class="w3ls-inner-title">media contact</h4>
                <div class="agielits-media">
                    <ul class="col-md-6 col-sm-6 agielits-media1">
                        <li><i class="fa fa-facebook"></i><a href="#">facebook.com/mediconnect</a></li>
                        <li><i class="fa fa-twitter"></i><a href="#">@cityline</a></li>
                    </ul>    
                    <ul class="col-md-6 col-sm-6 agielits-media1">    
                        <li><i class="fa fa-envelope"></i><a href="mailto:info@example.com">mail@mediconnect.com</a></li>
                        <li><i class="fa fa-laptop"></i><a href="index.php">www.mediconnect.com</a></li>
                    </ul>    
                    <div class="clearfix"></div>
                </div>  
